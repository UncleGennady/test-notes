...
import {inputsInitialValue, text, title, workspaceValues} from "../../model";
...
const Header = ({deleteHandle, lockHandle, unlockHandle}) => {
    ...
    const {lockedNotes } = useContext(LockedNotesContext)



    const addButtonHandle = () => {
        setWorkspace(workspaceValues.add)
        setCurrentNoteId(null)
        setCurrentNote(null)
        setInputs({...inputsInitialValue})
    }
    const editButtonHandle = () => {
        setWorkspace(workspaceValues.edit)
        const values = {
            title: currentNote.values[title],
            text: currentNote.values[text],
        }
        console.log(values)
        setInputs({...values})
    }
